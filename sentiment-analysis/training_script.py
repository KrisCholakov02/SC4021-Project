...
#? this is for training of timelms sentiment analysis model. 

max_length = 100
def tokenize_function(examples):
    #adjust this line v if there is errors
...
MODEL_NAME = 'cardiffnlp/twitter-roberta-base-sentiment-latest'  # change to desired model from the hub
